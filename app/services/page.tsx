  ...
  return (
    <div className="min-h-screen py-12 px-4 sm:px-2 bg-primary">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl sm:text-5xl font-bold text-center text-secondary dark:text-white mt-16 sm:mt-28">Our Key Weapons</h1>
